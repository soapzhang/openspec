 ...
 * Stores anonymous ID and notice-seen flag in ~/.config/opsc/config.json
 */
 ...
 * Uses ~/.config/opsc/config.json on all platforms.
 */
export function getConfigPath(): string {
  const configDir = path.join(os.homedir(), '.config', 'opsc');
