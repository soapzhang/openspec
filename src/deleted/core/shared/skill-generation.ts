...
export function getSkillTemplates(): SkillTemplateEntry[] {
  return [
    ...
    { template: getReleaseSkillTemplate(), dirName: 'opsc-release' },
...
export function getCommandTemplates(): CommandTemplateEntry[] {
  return [
    ...
    { template: getOpscReleaseCommandTemplate(), id: 'release' },
