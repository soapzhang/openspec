...
// Constants
export const GLOBAL_CONFIG_DIR_NAME = 'opsc';
export const GLOBAL_CONFIG_FILE_NAME = 'config.json';
export const GLOBAL_DATA_DIR_NAME = 'opsc';
 ...
 *
 * - All platforms: $XDG_CONFIG_HOME/opsc/ if XDG_CONFIG_HOME is set
 * - Unix/macOS fallback: ~/.config/opsc/
 * - Windows fallback: %APPDATA%/opsc/
 */
 ...
 *
 * - All platforms: $XDG_DATA_HOME/opsc/ if XDG_DATA_HOME is set
 * - Unix/macOS fallback: ~/.local/share/opsc/
 * - Windows fallback: %LOCALAPPDATA%/opsc/
 */
